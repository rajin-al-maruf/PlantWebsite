...
const WishlistProductCard = ({id,name,price,plantImg}) => {
  return (
    <Link to={`/product/${id}`}>
            ...
            <div className='p-2'>
                <div className='w-full h-full overflow-hidden flex items-center justify-center bg-neutral-100 relative group'>
                    ...
                    <div className="w-full h-full flex items-center justify-center bg-brand-primary/50 absolute top-0 left-0 rounded-md gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        <div className="flex items-center justify-center h-8 w-8 text-brand-primary-dark hover:text-brand-accent bg-brand-accent hover:bg-brand-primary-dark rounded-md">
                            <FaCartPlus size={15}/>
                        </div>
                        <div className="flex items-center justify-center h-8 w-8 text-brand-primary-dark bg-brand-accent hover:bg-red-600 hover:text-brand-accent rounded-md">
